...
var calendar = {
   ...
   */
  getSunday: function getSunday(y, m, n) {
  ...
  solar2lunar: function solar2lunar(y, m, d) {
    ...
    var astro = calendar.toAstro(m, d); //该日期所有的节日
    ...
    if (m == 1 && d == 1) {
      ...
      if (d == 1) festival.push('儿童节'); // if (d == 4) festival.push('青年节');
    ...
    return {
      ...
      textColor: festival.length > 0 ? '#222' : textColor
    };
  },
