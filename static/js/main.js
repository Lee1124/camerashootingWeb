...
var cosIp = sessionStorage.cosIp;
...
/**
 * 各个菜单的路由配置
 * pID:父级菜单id  pathList:子菜单集合 mName:权限对应的菜单名
 * mID:子菜单id  path:子菜单路由路径
 */
var menuPathList = [
  {
    pID: 2,
    pathList: [
      { mID: 11, mName: "出库列表", path: "outgoing" },
      { mID: 12, mName: "设备报损", path: "maintain" }
    ]
  }
];
...
function getkevalue() {
  var returnval = sessionStorage.userInfo;
  if (returnval == undefined) {
    return false;
  }
  // var returnval = 'http://localhost/|1|1|xlhl|http://localhost:5819/|http://171.211.126.122:8092/|1,1|http://192.168.1.79:8088|http://192.168.1.73:8088/';
